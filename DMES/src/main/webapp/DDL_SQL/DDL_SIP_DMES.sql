...
-- Started on 2015-04-27 11:22:45 COT
...
INSERT INTO sc_input_dimension (id_input_dimension, hight, width, large, weight, volume, thickness, radio, observations) VALUES (24, '43-Mms', '54-Mts', '8-KMS', '9-cm2', '', '', '', '');
...
SELECT pg_catalog.setval('sqscprocessemployee', 28, true);
...
SELECT pg_catalog.setval('sqscprocessinput', 17, true);
...
SELECT pg_catalog.setval('sqscprocessmachine', 26, true);
...
SELECT pg_catalog.setval('sqscprocessproduct', 19, true);
...
-- Completed on 2015-04-27 11:22:46 COT
