 ...
 * @author gchavarr88
 */
public class ScProductFormulation 
{

    //Declaración de Variables
    private List<ScInput> inputList;//Lista de insumos de la tabla
    private ScInput inputSelected; //Producto seleccionado para consulta, edición o eliminación
    private ScInput inputSave; //Producto seleccionado para agregar
    ...
    {    
        ...
        {
            if(validateFields("Nombre Producto", getInputSave().getDescription(), 3))
            {
    ...
    {    
        ...
        if(event.getOldStep().equals(TAB_GENERAL))
        {
            if(validateFields("Nombre Producto", getInputSelected().getDescription(), 3))
            {
                return event.getOldStep();
            }
